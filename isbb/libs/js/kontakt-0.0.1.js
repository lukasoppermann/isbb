function initialize() {
    var latlng = new google.maps.LatLng(52.55631,13.3850013);
    var myOptions = {
      zoom: 15,
      center: new google.maps.LatLng(52.55631,13.3828013),
...
function map_link()
{
	window.open('https://www.google.de/maps/place/Prinzenallee+22,+13359+Berlin','','');
}
